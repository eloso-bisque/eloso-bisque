...
export const metadata: Metadata = {
  title: 'Meet Eloso — ELO Forum',
  description: 'Book time with the Eloso team at the ELO Forum.',
};

export default function EloLandingPage() {
  return (
    <div className="min-h-screen bg-bisque-50 flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="text-bisque-700 text-lg mb-12 max-w-lg mx-auto leading-relaxed">
          We&apos;re here at the ELO Forum. Pick the conversation that fits where you are.
        </p>
